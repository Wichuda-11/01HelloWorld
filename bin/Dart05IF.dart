...
void main() {
  var objDouble2Format =
      NumberFormat('#,###,##0.00'); //clone NumberFormat() as objDouble2Format ทศนิยม2ตำแหน่ง
